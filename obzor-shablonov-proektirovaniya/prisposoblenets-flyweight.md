...
## Лес для деревьев {#лес-для-деревьев}
...
## Тысяча экземпляров {#тысяча-экземпляров}
...
## Шаблон приспособленец {#шаблон-приспособленец}
...
## Место где можно пустить корни {#место-где-можно-пустить-корни}
...
## Что насчет производительности? {#что-насчет-производительности}
